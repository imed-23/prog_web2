-- ============================================================
-- Gaming Campus — Script d'initialisation PostgreSQL
-- À exécuter sur la base PostgreSQL (psql ou code_execution)
--
-- Ce schéma est l'équivalent PostgreSQL de init.sql (qui est en MySQL).
-- Les pages PHP de l'app utilisent cette structure.
-- ============================================================
